...
const SearchBar = (props)=>{
    return(
        <div className='search-bar-main-basic'>
        <div style={{display:'flex', textAlign:'left', verticalAlign:'center', maxWidth:'100%'}}>
            <label className='search-main-icon-basic' style={{gridColumn:'1', fontSize:'30px', float:'left', fontColor:'white'}}><FontAwesomeIcon icon={faSearch} style={{color:"white"}}></FontAwesomeIcon></label>&nbsp;
