            ...
            <animated.div style={{
            ...
            }}>
                {
                    props.categoriasService.map(function (el, index) {
                        ...
                        return (
                            <div key={index} style={{ float: 'left', margin: '25px', padding: '25px', display: 'block', maxHeight:'250px', width: '960px', textAlign: 'left', color: 'white', overflowY:'auto'}} className={headercolors[index%headercolors.length]+" categoria-home"}>
                                <h1>{el.titulo}</h1>
                                <p>{el.descripcion}
                                </p>
